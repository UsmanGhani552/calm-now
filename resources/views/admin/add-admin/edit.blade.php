            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    ...
                    <div id="kt_app_content_container" class="app-container container-fluid">
                        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="{{route('add-admin.update',$addAdmin->id)}}" method="post">
                            @csrf
                            <!--begin::Main column-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Name" value="{{ old('name',$addAdmin->name) }}" />
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Card header-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <input type="email" name="email" class="form-control"
                                                placeholder="Email" value="{{ old('email',$addAdmin->email) }}" />
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Card header-->
