            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    ...
                    <div id="kt_app_content_container" class="app-container container-fluid">
                        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="{{route('post.store')}}" method="post">
                            @csrf
                            <!--begin::Main column-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea class="form-control" name="details" data-kt-autosize="true"></textarea>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Card header-->
