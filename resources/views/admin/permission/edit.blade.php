            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    ...
                    <div id="kt_app_content_container" class="app-container container-fluid">
                        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="{{ route('permission.update',$permission->id) }}" method="post">
                            @csrf
                            <!--begin::Main column-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name" value="{{$permission->name}}" class="form-control mb-2"
                                                placeholder="Name" />
                                        </div>
                                        <!--end::Input group-->
                                    </div>
