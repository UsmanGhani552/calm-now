        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    <form class="form d-flex flex-column flex-lg-row" action="{{ route('users.update',$user->id) }}" method="POST"
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <div class="mb-5 col-6">
                                            ...
                                            <input type="number" name="phone" class="form-control mb-2"
                                                placeholder="Contact Number" value="{{$user->phone}}" />
                                            @error('phone')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-5 col-6">
                                            ...
                                            <input type="file" name="image" class="form-control mb-2"
                                                placeholder="Contact Number" value="{{$user->image}}" />
                                            @error('image')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
