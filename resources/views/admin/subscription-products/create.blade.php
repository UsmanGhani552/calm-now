    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                <form class="form d-flex flex-column flex-lg-row" action="{{ route('subscription-product.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="fv-row">
                                    <div class="row">
                                        <div class="mb-5 col-6">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="product_id" class="form-control mb-2" placeholder="Product Id" value="" />
                                            @error('product_id')
